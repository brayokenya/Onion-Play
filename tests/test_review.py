...
def setUp(self):
        ...
        self.new_review = Review(movie_id=12345,movie_title='Review for movies',image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",movie_review='This movie is the best thing since sliced bread',user = self.user_Briankiiru )
...
def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_review.user,self.user_Briankiiru)
